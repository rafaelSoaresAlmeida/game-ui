...
export class StageScene extends Phaser.Scene {
  ...
  public init(params: GameProgress): void {
    ...
    this.filesBaseUrl = "images/battle-city/stages/stage" + this.gameProgress.getStageName();
  ...
  public preload(): void {
    this.load.image("game-background", "images/battle-city/images/backgrounds/game-background.png");
    ...
    this.load.image("game-tileset", "images/battle-city/images/tiles/game-tileset.png");

    this.load.spritesheet("game-bullet", "images/battle-city/images/sprites/bullet.png", { frameWidth: 12, frameHeight: 12 });
    this.load.spritesheet("game-bullet-explosion", "images/battle-city/images/sprites/bullet-explosion.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-enemy-regular", "images/battle-city/images/sprites/enemy-regular.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-enemy-speedy", "images/battle-city/images/sprites/enemy-speedy.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-enemy-shooter", "images/battle-city/images/sprites/enemy-shooter.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-enemy-heavy", "images/battle-city/images/sprites/enemy-heavy.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-fortress", "images/battle-city/images/sprites/fortress.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-player-one", "images/battle-city/images/sprites/player-one.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-player-two", "images/battle-city/images/sprites/player-two.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-points", "images/battle-city/images/sprites/game-points.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-spawn-blink", "images/battle-city/images/sprites/spawn-blink.png", { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet("game-tank-explosion", "images/battle-city/images/sprites/tank-explosion.png", { frameWidth: 96, frameHeight: 96 });

    this.load.image("game-enemies-count", "images/battle-city/images/sprites/logo-enemies.png");
    this.load.image("game-game-over", "images/battle-city/images/sprites/logo-game-over.png");
    this.load.image("game-level-count", "images/battle-city/images/sprites/logo-flag.png");
    this.load.image("game-lives-count", "images/battle-city/images/sprites/logo-lives.png");
    this.load.image("game-spawn-point", "images/battle-city/images/sprites/spawn-point.png");
  }
  ...
  public override update(time: any): void {
    ...
    this.enemies.getChildren().forEach((element) => {
      ...
      if (enemyShooting) { this.createBulletForEnemy(sprite); }
    });
  ...
  private collitionDestroyBullet(src: Phaser.Types.Physics.Arcade.GameObjectWithBody, dst: Phaser.Types.Physics.Arcade.GameObjectWithBody): void {

    if (src instanceof Phaser.Physics.Arcade.Sprite && src.getData !== undefined) {
    ...
    if (dst instanceof Phaser.Physics.Arcade.Sprite && dst.getData !== undefined) {
