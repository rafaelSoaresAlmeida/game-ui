...
export class ScoresScene extends Phaser.Scene {
  ...
  public preload(): void {
    this.load.image(
      'scores-background',
      'assets/images/backgrounds/scores-background.png',
    );
  }
  ...
  public create(): void {
    ...
    this.textStageNumber = this.add.bitmapText(
      292,
      119,
      'console-font',
      'STAGE  ' + this.gameProgress.stageNumber,
      24,
    );
    this.textStageNumber.setTint(0xeeeeee);

    const msgPlayerOnePoints = this.buildPlayerPoints(
      this.gameProgress.playerOneTotalPoints,
    );
    this.textPlayerOnePoints = this.add.bitmapText(
      124,
      215,
      'console-font',
      msgPlayerOnePoints,
    ...
    this.textPlayerOneRegulars = this.add.bitmapText(
      76,
      287,
      'console-font',
      defaultTankMessage,
    ...
    this.time.delayedCall(500, () => {
      const messagePlayerOneRegulars = this.buildTanksMessage(
        this.gameProgress.playerOneRegularsCount,
        this.gameProgress.playerOneRegularsPoints,
      );
      this.textPlayerOneRegulars.setText(messagePlayerOneRegulars);
    });

    this.textPlayerOneSpeedies = this.add.bitmapText(
      76,
      359,
      'console-font',
      defaultTankMessage,
    ...
    this.time.delayedCall(1000, () => {
      const msgPlayerOneSpeedies = this.buildTanksMessage(
        this.gameProgress.playerOneSpeediesCount,
        this.gameProgress.playerOneSpeediesPoints,
      );
      this.textPlayerOneSpeedies.setText(msgPlayerOneSpeedies);
    });

    this.textPlayerOneShooters = this.add.bitmapText(
      76,
      431,
      'console-font',
      defaultTankMessage,
    ...
    this.time.delayedCall(1500, () => {
      const msgPlayerOneShooters = this.buildTanksMessage(
        this.gameProgress.playerOneShootersCount,
        this.gameProgress.playerOneShootersPoints,
      );
      this.textPlayerOneShooters.setText(msgPlayerOneShooters);
    });

    this.textPlayerOneHeavies = this.add.bitmapText(
      76,
      503,
      'console-font',
      defaultTankMessage,
    ...
    this.time.delayedCall(2000, () => {
      const msgPlayerOneHeavies = this.buildTanksMessage(
        this.gameProgress.playerOneHeaviesCount,
        this.gameProgress.playerOneHeaviesPoints,
      );
      this.textPlayerOneHeavies.setText(msgPlayerOneHeavies);
    });

    this.textPlayerOneTotal = this.add.bitmapText(
      76,
      576,
      'console-font',
      defaultTotalMessage,
    ...
    this.time.delayedCall(2500, () => {
      const msgPlayerOneTotal = this.buildTotalMessage(
        this.gameProgress.playerOneStageCount,
      );
  ...
  private buildTanksMessage(tankCount: number, tankPoints: number): string {
    return (
      this.padRight(tankPoints, 4, ' ') +
      ' PTS ' +
      this.padRight(tankCount, 2, ' ')
    );
  }
